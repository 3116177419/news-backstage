  ...
  methods: {
    ...
    setCurveChartFn () {
      ...
      const aListAll = [
        ...
        { count: 90, date: '2022-04-21' },
        { count: 99, date: '2022-04-22' },
        { count: 120, date: '2022-04-23' },
        { count: 130, date: '2022-04-24' },
        { count: 147, date: '2022-04-25' },
        { count: 120, date: '2022-04-26' },
        { count: 90, date: '2022-04-27' },
        { count: 85, date: '2022-04-28' },
        { count: 90, date: '2022-04-29' },
        { count: 80, date: '2022-04-30' },
        { count: 82, date: '2022-05-01' },
        { count: 123, date: '2022-05-02' },
        { count: 163, date: '2022-05-03' },
        { count: 160, date: '2022-05-04' },
        { count: 139, date: '2022-05-05' },
        { count: 190, date: '2022-05-06' },
        { count: 180, date: '2022-05-07' },
        { count: 151, date: '2022-05-08' },
        { count: 80, date: '2022-05-09' },
        { count: 90, date: '2022-05-10' },
        { count: 120, date: '2022-05-11' },
        { count: 146, date: '2022-05-12' }
      ]
      ...
      const chartopt = {
        ...
        legend: { // 图例组件(每种颜色的意思)
          data: ['新增新闻'], // 图例文字解释(要和series里name对应)
          top: '40' // 距离容器顶部px
        },
        toolbox: { // 工具栏
          show: true, // 要显示
    ...
    picChartFn () {
      ...
      const oPieopt = {
        ...
        legend: { // 图例组件
          x: 'center',
          top: 65,
          data: ['奇异事件', '搞笑奇葩', '游戏解说', '博主网红'] // 每个部分对应的数据名(要和series里name对应)
        },
        toolbox: { // 工具箱
          show: true,
          x: 'center',
