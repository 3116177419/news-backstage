  ...
  <el-container class="main-container">
    ...
    <el-header>
      ...
      >
        <el-submenu index="1">
          ...
          <el-menu-item index="1-1" @click="gotoInfo">
            <i class="el-icon-s-operation"></i>基本资料
          </el-menu-item>
          <el-menu-item index="1-2" @click="gotoAvatar">
            <i class="el-icon-camera"></i>更换头像
          </el-menu-item>
          <el-menu-item index="1-3" @click="gotoPwd">
    ...
    <el-container>
      ...
      <el-container>
        ...
        <!-- 底部 footer 区域 -->
        <el-footer>©2022/6/21 - 小张原创</el-footer>
      </el-container>
    </el-container>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    ...
    async getMenusListFn () {
      ...
      console.log(res)
      res.data[1].title = '新闻列表'
      res.data[1].children[0].title = '新闻分类'
      res.data[1].children[1].title = '新闻发布'
      this.menus = res.data
    }
  }
}
